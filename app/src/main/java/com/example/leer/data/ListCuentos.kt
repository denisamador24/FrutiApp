...
class ListCuentos {
    companion object {
        val CuentosLis = listOf<Cuentos>(
            Cuentos("La tortuga Tomasa",
                R.drawable.img_cuentos,
                "Un día de sol la tortuga Tomasa se fue al se columpió y luego se cayó del columpio. Vino su" +
                        "parque. Allí amiga tortuga y la ayudó a levantarse. Jugando las dos tortugas encontraron una casa." +
                        "La casa estaba llena de agua. Abrieron las ventanas y la puerta y se vació de agua. Subieron al" +
                        "tejado y había un tambor y una trompeta. Las cogieron y se pusieron a tocar las. Al rato fueron a" +
                        "un bar a comprar un bocadillo de tomate y se lo tomaron en casa de Tomasa con un tenedor."
                ),

            Cuentos("Letra S: Superman",
                R.drawable.img_cuentos,
                "Un dia Superman estaba volando cuando vio a un monstruo. Superman le ganó y se fue volando a" +
                        "su casa. Se subió al tejado, el tejado se rompió porque estaba sucio y Superman se cayó, Se" +
                        "rompió un diente y se fue al dentista. El dentista era otro monstruo que se llamaba Samuel," +
                        "entonces Superman le ganó también y se fue a otro dentista que no dijera mentiras y fuera" +
                        "simpático. Alli se curó el diente. Al salir se encontre a una mosco, se hicieron amigas, se fueron de" +
                        "excursión la selva y lo pasaron muy bien."
                ),

            Cuentos("Letra R: Bl ratón y le rey",
                R.drawable.img_cuentos,
                "Erase una vez un ratón que iba caminando y se encontró con una rana, El ratón luego se fue al río " +
                        ...
                        "la tierra. Al lado había una rosa. El rey la tocó y se pincho. Le salió mucha sangre pero el ratón le " +
                        "curó y le puso una tirita"
                ),

            Cuentos("Los patitos",
                R.drawable.img_cuentos,
                "En un día de mucho calor, cinco patitos fueron a nadar al lago.\n " +
            ...
            Cuentos("Letra U: El unicornio y el huevo",
                R.drawable.img_cuentos,
                "Erase una vez un huevo que andaba por la carretera. Cuando el semáforo se puso verde se fue a la " +
                        "universidad. En la universidad estaba aprendiendo números y sacó un uno por-que no lo hizo bien. " +
            ...
            Cuentos("La rana Nena",
                R.drawable.img_cuentos,
                "Érase una vez una rana que se llamaba Nena, que estaba haciendo un muñeco de nieve. Cuando " +
                        ...
                        "jugaron juntas. Se cansaron y se sentaron en la nieve. Entonces se enfermaron y se tomaron el " +
                        "jarabe con naranja y se acostaron."),

            Cuentos("El león Lolo",
                R.drawable.img_cuentos,
            "Había una vez un león que se llamaba Lolo, un día se encontró un teléfono en el suelo. Lo cogió y " +
                    ...
                    "dijo: Ivete de mi casa!. De repente se hizo de noche y apareció el lobo. El león le dijo a su amigo " +
            ...
            Cuentos("Letra Q a mariquita y el mosquito",
                R.drawable.img_cuentos,
                "Una mariquito que se llamaba Quica fue a posear al bosque. En el bosque habia un periquito y un " +
                        ...
                        "y un paquete al periquito. Dentro del paquete había un quimona. El periquito se lo puso y le gustó " +
                        "porque era muy cómodo."
                ),

            Cuentos("Letra P: La pata y el pato",
                R.drawable.img_cuentos,
                "Había una vez una pata que se llamaba Pepa Pepa vivía en el agua del parque, Jugaba con una " +
                        ...
                        "porque era su cumpleaños. Cumplia seis añas Cuando le llevaba el pastel a su amigo se le " +
